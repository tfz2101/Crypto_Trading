...
start_date = datetime.datetime(2018, 4, 12, 0, 0, 0)
start_date = time.mktime(start_date.timetuple())
print('start date',start_date)
url = "https://api.bitfinex.com/v1/lends/btc/?limit_lends=6000?timestamp=" + str(start_date)
...
st.write_new(transactions_pd, 'btc_lending_ratesPRE.xlsx','sheet1')